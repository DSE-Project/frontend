...
const CustomSimulation = () => {
  ...
  // Filter features based on simulation mode
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 space-y-3 sm:space-y-0">
                <h2 className="text-xl font-semibold text-gray-800">
                  ...
                  <span className="ml-2 text-sm font-normal text-gray-500">
                    ({Object.keys(filteredFeatures).length} {simulationMode === 'simple' ? 'key' : 'total'} features)
                  </span>
                </h2>
                <div className="flex space-x-3">
                  <button
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{Object.keys(filteredFeatures).length}</span>
                </div>
                <div className="flex justify-between">
